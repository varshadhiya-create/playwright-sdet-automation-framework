  ...
  test.beforeEach(async ({ page }) => {
    await page.goto('/');
              ...
              test(
                ...
                // has this user signed in, which is the whole point of the fixture. A fresh context with
                // storageState still starts on about:blank, so an explicit navigation is required before
                // there is anything on screen for the login banner assertion to find.
